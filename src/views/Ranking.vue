  ...
  <div>
    <yd-infinitescroll :callback="loadList" ref="infinitescrollDemo">
      <yd-list theme="1" slot="list">
        ...
        <!-- p4-go2 -->
        <div class="c4-p4-tit c4-colbg" style="text-align: right"><img src="/static/img/xxx.jpg">
          <h3>排行榜</h3>
          <div class="fr">
          ...
          <ul>
            ...
            <li v-for="(item, index) in list">
              <div class="c4-p4-list-01">
                <img src="/static/img/xtb.jpg" class="c4-p4-list-02-bt" v-show="item.is_striker==1">
                ...
                <img :src="item.avatar|img" class="c4-p4-list-01-img">
                <h3 style="position: absolute;left: 90px;top: 30px;">{{item.name}}</h3>
    ...
    methods: {
      ...
      get() {
        ...
        if (this.type == 1) {
          ...
          clock_in.getCountRanking(p, data => {
            if (data.length == 0) {
              this.$refs.infinitescrollDemo.$emit('ydui.infinitescroll.loadedDone');
            } else {
              for (let i = 0; i < data.length; i++) {
          ...
          clock_in.getpaceRanking(p, data => {
            if (data.length == 0) {
              this.$refs.infinitescrollDemo.$emit('ydui.infinitescroll.loadedDone');
            } else {
              for (let i = 0; i < data.length; i++) {
